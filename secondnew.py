...
from ..utils.ca_layer8 import CALayer8


@MODELS.register_module()
class SECOND_CA8(BaseModule, nn.Module):
    ...
    def __init__(self,
        ...
        super(SECOND_CA8, self).__init__(init_cfg=init_cfg)
        ...
        for i, layer_num in enumerate(layer_nums):
            ...
            if i == len(out_channels) - 1 and used_ca:
                self.ca_list.append(CALayer8(out_channels[i], out_channels[i]))
