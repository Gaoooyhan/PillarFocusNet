...
def parse_args():
    parser = argparse.ArgumentParser(
        description='MMDet3D pointpillars_secondfpn_eca (and eval) a model')
    parser.add_argument('config', help='pointpillars_secondfpn_eca config file path')
    ...
    # will pass the `--local-rank` parameter to `tools/pointpillars_secondfpn_eca.py` instead
    # of `--local_rank`.
