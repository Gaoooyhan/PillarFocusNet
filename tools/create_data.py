...
import sys
sys.path.append("/home/gao/Gaooo/mmdetection3d-main")
...
def nuscenes_data_prep(root_path,
    ...
    if version == 'v1.0-pointpillars_secondfpn_eca':
        info_test_path = osp.join(out_dir, f'{info_prefix}_infos_test.pkl')
...
def lyft_data_prep(root_path, info_prefix, version, max_sweeps=10):
    ...
    lyft_converter.create_lyft_infos(
        root_path, info_prefix, version=version, max_sweeps=max_sweeps)
    if version == 'v1.01-pointpillars_secondfpn_eca':
...
if __name__ == '__main__':
    ...
    if args.dataset == 'kitti':
        ...
        if args.only_gt_database:
            ...
            test_version = f'{args.version}-pointpillars_secondfpn_eca'
            nuscenes_data_prep(
                root_path=args.root_path,
                info_prefix=args.extra_tag,
